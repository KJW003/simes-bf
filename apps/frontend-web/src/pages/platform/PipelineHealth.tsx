...
export default function PipelineHealth() {
  return (
    <div className="space-y-6">
      <PageHeader title="Pipeline" description="Santé du pipeline de données" />
      <Card>
        <CardContent className="py-12 flex flex-col items-center text-center space-y-4">
          ...
          <div className="pt-4 text-left w-full max-w-sm">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground"><span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50" />Métriques : uptime, latence, débit</li>
