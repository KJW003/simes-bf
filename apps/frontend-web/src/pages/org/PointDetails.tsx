...
export default function PointDetails() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title={"Point " + (pointId?.slice(0,8) ?? '')} description="Detail d un point de mesure" />
      <Card>
        <CardContent className="py-12 flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Ce module necessite un endpoint GET /points/:id avec historique et metriques.
            </p>
          </div>
          <div className="pt-4 text-left w-full max-w-sm">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-sm text-muted-foreground"><span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50" />KPIs temps reel du point</li>
