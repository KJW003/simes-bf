        ...
        <CardContent className="py-12 flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Ce module nécessite un pipeline de génération de rapports côté backend.
            </p>
          </div>
          <div className="pt-4 text-left w-full max-w-sm">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground"><span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/50" />Historique des rapports générés</li>
            </ul>
          </div>
        </CardContent>
      </Card>
